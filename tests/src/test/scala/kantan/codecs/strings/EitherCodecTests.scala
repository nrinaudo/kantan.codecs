...
class EitherCodecTests extends FunSuite with GeneratorDrivenPropertyChecks with Discipline {
  checkAll("StringDecoder[Either[Int, Boolean]]",
    DecoderTests[String, Either[Int, Boolean], Throwable, codecs.type].decoder[Int, Int])
  ...
  checkAll("StringCodec[Either[Int, Boolean]]",
    CodecTests[String, Either[Int, Boolean], Throwable, codecs.type].codec[Int, Int])

  checkAll("TaggedDecoder[Either[Int, Boolean]]",
    DecoderTests[String, Either[Int, Boolean], Throwable, tagged.type].decoder[Int, Int])
